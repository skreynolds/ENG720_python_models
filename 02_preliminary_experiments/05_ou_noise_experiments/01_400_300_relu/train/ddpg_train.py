...
def ddpg_train(env, agent, signal, n_episodes=10000, print_every=100):
    ...
    for i_episode in range(1, n_episodes+1):
        ...
        while True:
            ...
            #print('\rTime Step {}\tAverage Sim Time:  {:.2f}\t Average Train Time: {:.2f}'.format(env.t, np.mean(sim_times), np.mean(train_times)))

        # reduce noise
        agent.noise.noise_decay(0.999)
