...
class DdpgAgent():
    ...
    def __init__(self, config):
        ...
        Params
        ======
        - config (dict): dimension of each state
        """
        self.config = config
    ...
    def step(self, state, action, reward, next_state, done, do_train):
        ...
        if len(self.memory) > self.batch_size and do_train:
