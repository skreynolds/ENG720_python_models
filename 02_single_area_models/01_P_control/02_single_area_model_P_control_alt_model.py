...
def x1_control(x4_val, R_val):
    return (1/R_val)*x4_val
...
def int_power_system_sim(x_init, t, K_sg=1, T_sg=0.2,
    ...
    x_2_dot = (K_sg/T_sg)*(del_p_C - x1_control(x_init[2], R))  - (1/T_sg)*x_init[0]
    x_3_dot = (K_t/T_t)*x_init[0] - (1/T_t)*x_init[1]
    x_4_dot = (K_gl/T_gl)*(x_init[1] - del_p_L_func(t)) - (0.8/T_gl)*x_init[2]
    return x_2_dot, x_3_dot, x_4_dot
